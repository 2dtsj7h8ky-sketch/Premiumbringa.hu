...
const KESZLET = [
  ...
  { id:"cube-cross-sl", mappa:"CubeCrossSL", marka:"Cube", model:"Cube Cross SL", magassag:[174,188],
    ...
    leiras:"Csúcskategóriás cross-trekking versenyszintű felszereltséggel: Shimano XTR hátsó váltó, XT hidraulikus fékek, DT Swiss kerékszett, karbon kormány. Mindössze 12 kg. Egyenes kormányos, univerzális kerékpár városra, túrára és könnyű terepre. Esztétikailag szép, megkímélt; műszakilag kifogástalan." },
  ...
  { id:"ktm-ultra-flite", mappa:"KTMUltraFlite2", marka:"KTM", model:"KTM Ultra Flite", magassag:[168,180],
    ...
    leiras:"Sportos osztrák merevvázas MTB könnyű alumínium vázon, RockShox Judy villával. Minőségi Schwalbe gumipár, Shimano Deore hajtás. Ritkábban előforduló modell. Újszerű, gyári felszereltségű, sérülés- és karcmentes, legfeljebb 1–2 apró tárolási nyommal. Bevetésre kész." },
